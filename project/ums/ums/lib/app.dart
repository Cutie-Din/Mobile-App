...
import 'presentation/bloc/study_profile/study_profile_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/Quá trình học tập': (context) => BlocProvider(
              create: (context) => StudyProfileBloc(),
              child: const StudyProfileScreen(),
            ), // Màn hình quá trình học tập
      },
