...
//     theme.textFieldText =
//         theme.textFieldLabel.copyWith(fontSize: 16.0, color: AppColors.textGreyDark);
//     theme.textFieldTextDisabled = theme.textFieldText.copyWith(color: AppColors.textGrey1);
//     theme.textFieldHint =
//         theme.textFieldText.copyWith(fontWeight: FontWeight.w400, color: AppColors.textGrey2);
//     theme.textFieldHintDisabled = theme.textFieldHint.copyWith(color: AppColors.textGrey1);
//     theme.textFieldError =
//         theme.textFieldLabel.copyWith(fontWeight: FontWeight.w400, color: AppColors.red);
